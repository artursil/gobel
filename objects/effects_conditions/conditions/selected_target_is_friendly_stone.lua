--- Gate-only condition: pass when the selected board target is a friendly stone.
---
--- Evaluated before forge card apply. Uses ``selected_stone.target_with_coords`` and compares
...
---
--- @module objects.effects_conditions.conditions.selected_target_is_friendly_stone
...
--- Return pass when selected coordinates hold a friendly stone for the effect owner.
--- @param state table
--- @param _owner string
