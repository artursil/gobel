--- Pass when the selected target is an enemy stone for the effect owner.
--- @module objects.effects_conditions.helpers.conditions.selected_target_is_enemy_stone
...
--- Enemy stone at selected coordinates relative to effect owner.
