...
--- @module objects.effects_conditions.helpers.shared.connected_group_placement
...
local function apply_group(state, owner, row, col, opts)
...
function M.apply_wall(state, owner)
	apply_group(state, owner, nil, nil, {
		stone_kind = "wall",
