...
---
--- Stone under test: territory_to_multiplier_stone (letter Z).
...
--- because the case 01 layout has only black influence). place_stone matches set_board + Z.
--- Structurally parallel to territory_to_points_stone but asserts plus_mult.
---
...
--- @return integer
local function t2m_payout(territory_count)
	return math.min(S.t2m_cap, math.floor(territory_count / S.t2m_divisor))
end
...
describe("territory_to_multiplier_stone (visual ASCII)", function()
	...
	describe("case 01: single black in center influence", function()
		...
		it("own territory: black receives payout", function()
			...
			assert_player_plus_mult_delta(g, "black", snap, t2m_payout(black_territory), "black-owned cell (1,1)")
			assert_player_plus_mult_unchanged(g, "white", snap, "white unchanged")
		end)
		...
		it("opponent territory: white receives payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_delta(g, "white", snap, t2m_payout(white_territory), "white-owned cell (5,1)")
			assert_player_plus_mult_unchanged(g, "black", snap, "black unchanged")
		end)
	end)
	...
	describe("case 03: black ring with single empty center", function()
		...
		it("own territory: black receives payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_delta(g, "black", snap, t2m_payout(black_territory), "black-owned cell (4,2)")
			assert_player_plus_mult_unchanged(g, "white", snap, "white unchanged")
		end)
		...
		it("neutral territory: no payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_unchanged(g, "black", snap, "contested cell (4,1) pays black nothing")
			assert_player_plus_mult_unchanged(g, "white", snap, "contested cell (4,1) pays white nothing")
		end)
		...
		it("opponent territory: white receives payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_delta(g, "white", snap, t2m_payout(white_territory), "white-owned cell (1,2)")
			assert_player_plus_mult_unchanged(g, "black", snap, "black unchanged")
		end)
	end)
	...
	describe("case 04: white edge pressure top-left", function()
		...
		it("own territory: black receives payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_delta(g, "black", snap, t2m_payout(black_territory), "black-owned cell (6,4)")
			assert_player_plus_mult_unchanged(g, "white", snap, "white unchanged")
		end)
		...
		it("neutral territory: no payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_unchanged(g, "black", snap, "contested cell (5,4) pays black nothing")
			assert_player_plus_mult_unchanged(g, "white", snap, "contested cell (5,4) pays white nothing")
		end)
		...
		it("opponent territory: white receives payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_delta(g, "white", snap, t2m_payout(white_territory), "white-owned cell (1,3)")
			assert_player_plus_mult_unchanged(g, "black", snap, "black unchanged")
		end)
	end)
	...
	describe("case 05: multiple enclosures", function()
		...
		it("own territory: black receives payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_delta(g, "black", snap, t2m_payout(black_territory), "black-owned cell (5,4)")
			assert_player_plus_mult_unchanged(g, "white", snap, "white unchanged")
		end)
		...
		it("neutral territory: no payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_unchanged(g, "black", snap, "contested cell (7,5) pays black nothing")
			assert_player_plus_mult_unchanged(g, "white", snap, "contested cell (7,5) pays white nothing")
		end)
		...
		it("opponent territory: white receives payout", function()
			...
			test_helper.finish_turn(g)
			assert_player_plus_mult_delta(g, "white", snap, t2m_payout(white_territory), "white-owned cell (8,4)")
			assert_player_plus_mult_unchanged(g, "black", snap, "black unchanged")
		end)
	end)
end)
