...
local function card_ui_state()
	local controller = helper.get_upvalue(love.mousemoved, "card_controller")
		or helper.get_upvalue(love.mousepressed, "card_controller")
...
describe("Card UI flow", function()
	...
	it("Sale Prep uses Use then Confirm with two popup discard targets", function()
		...
		assert.is_nil(next(card_ui.card_target_hint_cells))
		love.mousepressed(use.x + 2, use.y + 2, 1)
